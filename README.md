...
- Browser Client: the client side website / interface, which allows clients to manage hardware devices. Intended to be deployed: on your browser (i.e. by visiting https://firmware.HugosTechLab.com)
...
```mermaid
flowchart TD
    browserclient["RFM Web HTML (your PC)"] --> cloud
